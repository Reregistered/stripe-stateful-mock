...
export namespace accounts {
  ...
  export function create(
    ...
    const account: Stripe.Account = {
      ...
      business_profile: {
        ...
        product_description:
          params.business_profile?.product_description || null,
  ...
  export function retrieve(
    ...
    if (accountId !== "acct_default" && accountId !== connectedAccountId) {
      throw new RestError(400, {
        message:
          "The account specified in the path of /v1/accounts/:account does not match the account specified in the Stripe-Account header.",
        type: "invalid_request_error",
      });
    }
